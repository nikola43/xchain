...
import (
	...
	"github.com/galaxy-foundation/icicb-base/utils/workers"

	"github.com/goicicb/ethapi"
	"github.com/goicicb/eventcheck"
	"github.com/goicicb/eventcheck/basiccheck"
	"github.com/goicicb/eventcheck/epochcheck"
	"github.com/goicicb/eventcheck/gaspowercheck"
	"github.com/goicicb/eventcheck/heavycheck"
	"github.com/goicicb/eventcheck/parentscheck"
	"github.com/goicicb/evmcore"
	"github.com/goicicb/galaxy"
	"github.com/goicicb/gossip/blockproc"
	"github.com/goicicb/gossip/blockproc/drivermodule"
	"github.com/goicicb/gossip/blockproc/eventmodule"
	"github.com/goicicb/gossip/blockproc/evmmodule"
	"github.com/goicicb/gossip/blockproc/sealmodule"
	"github.com/goicicb/gossip/blockproc/verwatcher"
	"github.com/goicicb/gossip/emitter"
	"github.com/goicicb/gossip/filters"
...
func (s *Service) Stop() error {
	defer log.Info("icicb-galaxy service stopped")
	s.verWatcher.Stop()
	close(s.done)
	s.emitter.Stop()
	s.pm.Stop()
