...
import (
	...
	"github.com/goicicb/cmd/galaxy/launcher/metrics"
	"github.com/goicicb/cmd/galaxy/launcher/tracing"
	"github.com/goicicb/debug"
	"github.com/goicicb/flags"
	"github.com/goicicb/gossip"
	"github.com/goicicb/integration"
	"github.com/goicicb/utils/errlock"
	"github.com/goicicb/valkeystore"
	_ "github.com/goicicb/version"
)
	...
	if ctx.GlobalBool(utils.ExitWhenSyncedFlag.Name) {
		go func() {
			for first := true; ; first = false {
				// Call icicb_syncing until it returns false
				time.Sleep(5 * time.Second)

				var syncing bool
				err := rpcClient.CallContext(context.TODO(), &syncing, "icicb_syncing")
				if err != nil {
					continue
				}
				if !syncing {
